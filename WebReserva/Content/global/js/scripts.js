! function(e) {
    ...
    function t() {
        e(".awe-calendar:not(.from, .to)").datepicker({
            ...
            buttonImageOnly: !1,
            minDate: 0,
            onClose: function(dataEscolhida) {
                var chosenDate = dataEscolhida.split("/")[1] + "/" + dataEscolhida.split("/")[0] + "/" + dataEscolhida.split("/")[2],
                    arrivalDate = new Date(chosenDate),
                    arrivalDatePlusOne = new Date(arrivalDate.getTime() + 864e5),
                    departureDate = arrivalDatePlusOne.getMonth() + 1 + "/" + arrivalDatePlusOne.getDate() + "/" + arrivalDatePlusOne.getFullYear(),
                    dataSaida = departureDate.split("/")[1] + "/" + departureDate.split("/")[0] + "/" + departureDate.split("/")[2];
                e(".awe-calendar.to").datepicker("option", "minDate", dataSaida).focus()
            }
    ...
    function q(e, t, a, n) {
        var i = {
            url: "/Content/global/img/icon-marker.png",
